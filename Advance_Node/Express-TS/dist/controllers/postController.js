...
exports.searchPost = exports.fetchPost = void 0;
...
const fetchPost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const output = yield postService.fetchPostData(sort, page, itemPerPage);
...
const searchPost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const output = yield postService.searchPost(query, page, itemPerPage);
